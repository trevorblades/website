...
After some searching on the web, I learned that [KaTeX](https://katex.org/) was the right tool for the job. It takes a string of text written in [TeX](https://en.wikipedia.org/wiki/TeX) syntax and outputs nicely formatted mathematical notation. In Markdown, it's common to see $\TeX$ written inside math blocks beginning and ending with `$$`.
