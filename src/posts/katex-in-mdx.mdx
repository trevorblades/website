---
title: 'Recipe: KaTeX With Gatsby and MDX'
description: How to use mathematical notation in your blog posts
---
...
After some searching on the web, I learned that [KaTeX](https://katex.org/) was the right tool for the job. It takes a string of text written in [TeX](https://en.wikipedia.org/wiki/TeX) syntax and outputs nicely formatted mathematical notation. In Markdown, it's common to see TeX written inside math blocks `$$`.
...
The above Markdown becomes the following using KaTeX:
...
Add the remark plugins to the configuration and include the CSS styles from the `katex` package with your site code.
...
That's it! Hope this short guide was helpful to anybody trying to set up KaTeX with a similar tech stack.
